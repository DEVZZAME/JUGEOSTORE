...
<title>주거상점:휴가용 임대 숙소, 통나무집, 비치하우스 독특한 숙소</title>
...
<div class="wrap">
   ...
   <p>
   <a href="${contextPath }/logout.do" class="menu_bar">
   로그아웃                                           
   </a>
   </p>
   </c:if>
   ...
   <p class="menu_bar" onclick="location.href='myPage.do'">마이페이지</p>
   <p class="menu_bar" onclick="location.href='list.do'">예약하기</p>
        ...
        <div class="search">
            <div class="search_block1">
                <div class="location">
                    ...
                    <input type="text" class="search_input" placeholder="어디로 여행가세요?">
                </div>
                <div class="sub1" style="display: block;">
                    <div class="search_location" >
                        <p class="sub_back1">언제 어디로든 떠나는 여행</p>
                       <p class="flex_search"><a href="list.do">유연한 검색</a></p>
                    </div>
                </div>
            </div>
            <!-- search_block1 -->
               ...
               <div class="search_block2">
                <div class="checkIn checkOut">
                    <div class="InOut" id="In">
                        <label for="location">체크인/체크아웃</label>
                        <input type="text" class="search_input" id="demo" name="demo" placeholder="날짜 입력" />
                        <!-- 새로 추가된 부분 -->
               ...
               <div class="search_block4">
                <div class="guest">
                    <div>
                        ...
                        <input type="text" id="res" class="search_input" placeholder="게스트 추가">
                    </div>
                    <div>
                        <img src="${pageContext.request.contextPath}/resources/img/search.png" class="search_img">
                    </div>
                </div>
                <!-- 새로 추가된 부분 -->
                    ...
                    <div class="search_guest">
                        <div class="guest_wrap1">
                            ...
                            <div class="guest_right">
                                <input class="guest_button"
                                        type='button'
                                        id="minusbutton"
                                        onclick='count("minus1")'
                                        value='-'
        ...
        <div class="white_section">
            <div class="city_cards_container">
                <div class="city_card" onclick="location.href='list.do'">
                    <img src="${pageContext.request.contextPath}/resources/img/nav1.jpg" alt="Vienna">
                    <div>
                ...
                <div class="city_card">
                    <img src="${pageContext.request.contextPath}/resources/img/nav2.jpg" alt="Vienna">
                    <div>
                ...
                <div class="city_card">
                    <img src="${pageContext.request.contextPath}/resources/img/nav3.jpg" alt="Vienna">
                    <div>
                ...
                <div class="city_card">
                    <img src="${pageContext.request.contextPath}/resources/img/nav4.jpg" alt="Vienna">
                    <div>
                ...
                <div class="city_card">
                    <img src="${pageContext.request.contextPath}/resources/img/nav5.jpg" alt="Vienna">
                    <div>
                ...
                <div class="city_card">
                    <img src="${pageContext.request.contextPath}/resources/img/nav6.jpg" alt="Vienna">
                    <div>
            ...
            <div class="live_container">
                <div class="live_card">
                    <img src="${pageContext.request.contextPath}/resources/img/live1.jpg" alt="host1">
                    <p>자연생활을 만끽할 수 있는 숙소</p>
                </div>
                <div class="live_card">
                    <img src="${pageContext.request.contextPath}/resources/img/live2.jpg" alt="host1">
                    <p>독특한 공간</p>
                </div>
                <div class="live_card">
                 <img src="${pageContext.request.contextPath}/resources/img/live3.jpg" alt="host1">
                    <p>집 전체</p>
                </div>
            </div>
        </div>
